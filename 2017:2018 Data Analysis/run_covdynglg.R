...
run_covdynglg <- function(M=20000){
  ...
  # Regions are created for proposal distirbutions
  ind = 1:Inew
  ...
  # Divide time points
  # This is used to generate a proposal distribution for
  # lambda2
  indrt = 1:J
  ...
  system.time(for (k in 1:M){
    ...
    tau2k = 1/rgamma(1,(J*Inew)/2+0.001,bk/2 + 0.0001)
